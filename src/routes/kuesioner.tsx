...
const submit = () => {
    ...
    const payload = {
      data: {
        ...
        "Seberapa penting kemudahan penggunaan aplikasi dalam memilih platform streaming musik?": record.ratings.kemudahan,
        "Ada komentar lain terkait sesi atau agenda acara secara keseluruhan?": "-",
